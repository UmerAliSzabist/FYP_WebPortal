...
export default function FundDetail(props) {
    ...
    const fetchAllRiders = () => {
        Axios.get(`${BASE_URL}/admin/allRiders`)
            .then((res) => {
                console.log(res);
                ...
                <div className={classes.dashboard}>
                    ...
                    <div style={{ display: 'flex', flex: 0.4, flexDirection: 'row'}}>
                        <div style={{ display: 'flex', flex: 0.5, flexDirection: 'column' }}>
                            ...
                            <div style={{ display: 'flex', flex: 0.2, justifyContent: 'center', alignItems: 'center', alignContent: 'center', }}>
                                <Typography style={{ fontSize: 15, color: 'black' }}>No Of Days {allAdDetails.numberOfDays}</Typography>
                            </div>
                            <div style={{ display: 'flex', flex: 0.2, justifyContent: 'center', alignItems: 'center', alignContent: 'center', }}>
                        ...
                        <div style={{ display: 'flex', flex: 0.5, flexDirection: 'column' }}>
                            ...
                            <div style={{ display: 'flex', flex: 0.2, justifyContent: 'center', alignItems: 'center', alignContent: 'center', }}>
                                <Typography style={{ fontSize: 15, color: 'black' }}>Rs.{allAdDetails.price} Total Price</Typography>
                            </div>
                            <div style={{ display: 'flex', flex: 0.2, justifyContent: 'center', alignItems: 'center', alignContent: 'center', }}>
                                <Typography style={{ fontSize: 15, color: 'black' }}>{allAdDetails.city} </Typography>
                            </div>
                        </div>
                    </div>
                    <div style={{ display: 'flex', flex: 0.3, flexDirection: 'column' }}>
                        <div style={{ display: 'flex', flex: 0.2,flexDirection: 'column', justifyContent: 'center' }}>
                            <Typography style={{ fontSize: 22, color: 'black', textAlign: 'center' }}>Assign To Rider</Typography>
                        </div>
                        <div style={{ display: 'flex', flex: 0.5, flexDirection: 'column', justifyContent: 'center', margin:10 }} >
                            <Box sx={{ minWidth: 120 }} >
                                    ...
                                    >
                                            {
                                                riderDetails.map((rider) => (
                                                    <MenuItem key={rider._id} value={rider._id}>{rider.name}</MenuItem>
                                                ))
                                            }
                        ...
                        <div style={{ display: 'flex', flex: 0.3, flexDirection: 'column', justifyContent: 'center', alignContent: 'center', alignItems: 'center' }}>
                            <LoginButton variant="contained" color="primary" style={{ width: '150px' }} onClick={handleAssignToRiderButton}>
                                Assign To Rider
                            </LoginButton>
                        </div>
                    </div>
